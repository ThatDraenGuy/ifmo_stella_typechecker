...
public class ErrorUnexpectedTypeForStrictExpression extends ErrorUnexpectedTypeForExpression {
    private final StellaParser.ExprContext expr;
    private final StellaType expected;
    private final StellaType actual;

    public ErrorUnexpectedTypeForStrictExpression(StellaParser.ExprContext expr, StellaType expected, StellaType actual) {
        this.expr = expr;
