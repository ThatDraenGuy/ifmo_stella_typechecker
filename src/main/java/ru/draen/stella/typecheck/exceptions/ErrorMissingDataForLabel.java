...
public class ErrorMissingDataForLabel extends TypeCheckException {
    private final StellaParser.VariantContext variant;
    private final StellaType expected;
    private final String label;


    public ErrorMissingDataForLabel(StellaParser.VariantContext variant, StellaType expected, String label) {
