...
public class ErrorStrictUnexpectedNumberOfParametersInLambda extends ErrorUnexpectedNumberOfParametersInLambda {
    private final StellaParser.AbstractionContext lambda;
    private final int expected;
    private final int actual;
    private final StellaType type;

    public ErrorStrictUnexpectedNumberOfParametersInLambda(StellaParser.AbstractionContext lambda, int expected, int actual, StellaType type) {
        this.lambda = lambda;
